...
var textStatVrfy="추첨 스크립트의 확률적 균일성(uniform distribution)을 검증합니다. 추첨 스크립트는 수 많은 시행에서 각 당첨자가 당첨될 확률이 균일해야 합니다. 수학의 교묘한 특성을 활용하면 랜덤 소스에 상관 없이 특정한 수로 수렴할 수가 있습니다. 본 검증은 그러한 공격을 탐지하기 위함입니다."
