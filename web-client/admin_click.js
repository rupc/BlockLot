...
$(document).ready(function() {
    ...
    var printCounterfeit = function(cell, formatterParams){ //plain text value
        return "<i class='fa fa-eyedropper'  style='font-size:28px;color:Red '></i>";
    };
    ...
    $("#allQueryTableReserved").tabulator({
        ...
        columns:[ // Define Table Columns
            ...
            {title:"Event Name", headerSort:false, field:"name", width:"18px"},
            {title:"Announcement Date", field:"announceDate", align:"center", sorter:"date", width:"12px"},
            {title:"예정발표일(타임스탬프)", field:"tsAnnounceDate", align:"center", sorter:"date", width:"12px"},
            {title:"# of Participants", headerSort:false, field:"numOfRegistered", align:"center", width:"9px"},
            {title:"# of Winners", headerSort:false, field:"numOfWinners", align:"center", width:"9px"},
            {title:"Counterfeit", headerSort:false, field:"subscribe", formatter:printCounterfeit, align:"center", width:"4px", 
                cellClick:function(e, cell){
                    ...
                    if(status != "CHECKED") {
                        swal({type:"error", title:"당첨자 조작은 추첨 이후에 가능",
                            confirmButtonText: '확인',
                            cancelButtonText: '취소',
                        });
                        return;
                    ...
                    Swal({
                        ...
                        confirmButtonText: '조작하기',
                        cancelButtonText: '그만두기'
                    }).then((result) => {
                        showSpinner();
                        if (result.value) {
                            var fraudWinners = result.value;
                            functionName = "counterfeit";
                            console.log(fraudWinners);
                            var allData = {
                                "fraudWinners" : fraudWinners,
                                "eventHash" : eventHash,
                            ...
                            hideSpinner();
                            console.log("No list entered");
                        }

                    })
                }},
            {title:"Subs.", headerSort:false, field:"subscribe", formatter:printSubscribeIcon, align:"center", width:"4px", 
                cellClick:function(e, cell){
                    var lotteryName = cell.getRow().getData().name;
                    ...
                    Swal({
                        ...
                        html: "If you entered an email address, then token is sent to it.<br>(<b>BlockLot provides anonimity for participants</b>)",
                        type: 'question',
                        input: 'text',
            ...
            {title:"Draw", headerSort:false, field:"draw", formatter:printDrawIcon, align:"center", width:"4px",
                cellClick:function(e, cell) {
            ...
            {title:"Check", field:"check", formatter:printCheck, align:"center", width:"4px",  headerSort:false, 
                cellClick:function(e, cell) {
                    var lotteryName = cell.getRow().getData().name;
                    var targetBlockNumber = cell.getRow().getData.targetBlock;
            ...
            {title:"Verify", field:"verify",formatter:printVerify, align:"center", width:"4px",headerSort:false, 
                cellClick:function(e, cell){
...
// var peerResponse = JSON.parse(responseData).peersResponses;
            ...
            {title:"Info", formatter:printIcon, field:"info", align:"center", width:"4px",headerSort:false, 
                cellClick:function(e, cell) {
    ...
    $( "#openLotteryBtn" ).click(function() {
        ...
        swal({
            title: 'Open new lottery event',
            html:
            '<input id="eventName" placeholder="Event name" style="width:100%;" class="swal2-input">' +
            '<input id="numOfWinners" placeholder="# of winners" min="1" style="float:left; width:120%;" type="number" class="swal2-input">' + 
            '<input id="expectedAnnouncementDate" placeholder="Announcement Date"style="width:100%;" type="datetime" value="' + defaultDatetime  + '"class="swal2-input">' +
            '<input id="targetBlockOffset" placeholder="Block offset"style="float:left;width:250;" type="number" min="2"  class="swal2-input">' +
            '<input id="lotteryNote" placeholder="Lottery note(e.g., present list)"  class="swal2-input"style="float:left;width:250;height:400;" type="input">',
            focusConfirm: false,
            showCancelButton: true,
